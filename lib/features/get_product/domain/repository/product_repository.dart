...
abstract class ProductRepository {
  Future<PaginatedProducts> getProducts({required int page, required int limit}); // Updated return type
  Future<ProductModel?> getProductBySerialNumber(String serialNumber);
}
