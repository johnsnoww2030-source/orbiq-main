...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( ThemeEntity theme)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ThemeInitial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( ThemeEntity theme)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case ThemeInitial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( ThemeEntity theme)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case ThemeInitial() when initial != null:
return initial();case ThemeLoading() when loading != null:
return loading();case ThemeLoaded() when loaded != null:
